...
ifeq ($(config),debug32)
  ...
  ALL_CXXFLAGS       += $(CXXFLAGS) $(CFLAGS) $(ALL_CPPFLAGS) $(ARCH) -m32 -x c++ -std=c++11
...
ifeq ($(config),debug64)
  ...
  ALL_CXXFLAGS       += $(CXXFLAGS) $(CFLAGS) $(ALL_CPPFLAGS) $(ARCH) -m64 -x c++ -std=c++11
...
ifeq ($(config),debug)
  ...
  ALL_CXXFLAGS       += $(CXXFLAGS) $(CFLAGS) $(ALL_CPPFLAGS) $(ARCH) -x c++ -std=c++11
